...
#include "$(basename #include "ggml-common.h" )"
#endif
#include "$(basename #include "ggml-metal-impl.h" )"
...
#define HIGH_END_DEVICE 1
#define USE_SIMDGROUP_REDUCTION 1
#define USE_METAL_FLOAT16 1
